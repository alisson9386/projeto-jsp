 ...
 <nav class="navbar header-navbar pcoded-header">
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      ...
                      <a href="index.html">
                          <img class="img-fluid" src="<%=request.getContextPath() %>/assets/images/logo.png" alt="Theme-Logo" style=" max-width:150px; max-height:50px; width: auto; height: auto;" />
                      </a>
                  ...
                  <div class="navbar-container container-fluid">
                      ...
                      <ul class="nav-right">
                          <li class="header-notification">
                              ...
                              <ul class="show-notification">
                                  ...
                                  <li class="waves-effect waves-light">
                                      <div class="media">
                                          <img class="d-flex align-self-center img-radius" src="<%=request.getContextPath() %>/assets/images/avatar-alisson.jpg" alt="Generic placeholder image">
                          ...
                          <li class="user-profile header-notification">
                              <a href="#!" class="waves-effect waves-light">
                                  <img src="<%=request.getContextPath() %>/assets/images/avatar-alisson.jpg" class="img-radius" alt="User-Profile-Image">
