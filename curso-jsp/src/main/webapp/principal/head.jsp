...
<head>
    <title>Curso JSP - Alisson Treinamentos</title>
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="author" content="Alisson Deives Vieira" />
      <!-- Favicon icon -->
      <link rel="icon" href="<%=request.getContextPath() %>/<%=request.getContextPath() %>/assets/images/cruzeiro.ico" type="image/x-icon">
    <!-- Google font-->
