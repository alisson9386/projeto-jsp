											...
											<div class="col-sm-12">
												...
												<div class="card">
													<div class="card-block">
														...
														<form class="form-material" method="post" action="<%= request.getContextPath() %>/ServletUsuarioController" id="formUser">
														...
														<input type="hidden" name="acao" id="acao" value="">
												            ...
												            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModalUsuario">Pesquisar usuarios</button>
                                                        </form>
													</div>
												</div>
											</div>
			...
			$.ajax({
				...
				success: function(response) {
					...
					for(var p = 0; p < json.length; p ++){
						$('#tabelaUsuarios > tbody').append('<tr> <td>' + json[p].id + '</td> <td>' + json[p].nome + '</td> <td> <button onclick="verEditar('+json[p].id+')" type="button" class="btn btn-dark"><i class="bi bi-check-circle"></i></button> </td> </tr>');
